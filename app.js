...
//     window.sunflower.position.set(xrCamera.position.x, xrCamera.position.y, xrCamera.position.z - 3);
//     window.sunflower.rotation.set(xrCamera.rotation.x, xrCamera.rotation.y, xrCamera.rotation.z);
...
// }
  ...
  onSelect = () => {
    ...
    if (window.sunflower && counter < 2) {
      ...
      //     console.log(array)
      //     console 
      //     console.log(DOMPoint.fromPoint(array[i][0], array[i][1], array[i][2]))
      //   }
      // }
        ...
        console.log("this is a string: " + myJSON);
  

        var thenum = myJSON.replace( /x|y|z|(['"])|:|{|}/g, '');
        console.log("these are only numbers " + thenum);
        ...
        // console.log(XRFrame.getPose(clone.position, this.localReferenceSpace));
        // console.log(XRFrame.getViewerPose(this.localReferenceSpace));
        // this.animatearrow();

        //console.log(stringtoArray(myJSON));
